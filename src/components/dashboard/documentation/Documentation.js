				...
				<Col lg={12} md={12} sm={12}>
					<div className="border-bottom pb-4 mb-4 d-md-flex justify-content-between align-items-center">
						<div className="mb-3 mb-md-0">
							<h1 className="mb-0 h2 fw-bold">EmergeLMS React</h1>
							<p className="mb-0">
								Welcome to the EmergeLMS ReactJS version of the original EmergeLMS
								theme.
							</p>
						</div>
					</div>
				...
				<Col lg={7} md={12} sm={12}>
					<Card>
						<Card.Body>
							...
							<p className="lead">
								A professional EmergeLMS React Kit that comes with plenty of
								ready-to-use components that will help you to build more
								beautiful application (web app) and frontend pages.{' '}
							</p>

							<p>
								EmergeLMS UI Kit is built with the most popular front-end framework{' '}
								<a
							...
							<p>
								This doc will guide you to understand how EmergeLMS-React theme is
							...
							<ol>
								...
								<li>
									{' '}
									<h4 className="mb-0 fw-bold">Install EmergeLMS React</h4>
									<p>
										Open the <span>"emerges-react” </span>directory with your cmd
									...
									<p>
										...
										for emerges in the node_modules directory.
									</p>
								</li>
								<li>
