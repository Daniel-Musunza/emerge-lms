...
// import data files
import DeveloperEmergeLMSData from 'data/marketing/compare-plans/DeveloperEmergeLMSData';

// import MDI icons
import Icon from '@mdi/react';
import { mdiHeart, mdiFormatQuoteOpen } from '@mdi/js';

const DeveloperEmergeLMS = () => {
	return (
		<section className="pb-14 pt-8 ps-0 bg-light ">
			<Container>
				...
				<Row>
					{DeveloperEmergeLMSData.map((item, index) => {
						return (
...
export default DeveloperEmergeLMS;
